Repositório do grupo de estudos sobre GraphQL do [Training Center](https://training-center.github.io).
...
Este grupo se destina ao estudo de GraphQL.
...
Caso você precise entrar em contato com as pessoas responsáveis por este grupo de estudos, pode chamar por `@leoturbiani` no Slack do Training Center.
